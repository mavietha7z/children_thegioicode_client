            ...
            <Col md={20} xs={24} style={{ padding: '0 8px' }}>
                <Card style={{ minHeight: 'calc(-148px + 100vh)' }}>
                    ...
                    <div className="font-size-15 netcode-tgc">
                        <em>
                            <b>
                                Các điều khoản sử dụng được Netcode thiết lập với mục đích nhằm đảm bảo giúp khách hàng cũng như Netcode
                                tránh được các trường hợp vi phạm pháp luật theo quy định hiện hành của nước Cộng hòa xã hội chủ nghĩa Việt
                                Nam đồng thời cũng giúp khách hàng bảo mật được thông tin cá nhân cùng toàn bộ dữ liệu của mình trong quá
                                trình sử dụng sản phẩm – dịch vụ của Netcode. Khi khách hàng tạo tài khoản và sử dụng sản phẩm – dịch vụ của
                                Netcode đồng nghĩa với việc khách hàng đã hoàn toàn đồng ý và chấp thuận với các điều khoản sử dụng mà
                                Netcode đã đưa ra.
                            </b>
                        </em>

                        <div className="mt-5">
                            <h2>1. Trách nhiệm của Netcode</h2>

                            <ul>
                                <li>
                                    Netcode đảm bảo cung cấp dịch vụ như đã cam kết trong{' '}
                                    ...
                                    như đã công bố trên các website chính thức của Netcode.
                                </li>
                                <li>
                                    Netcode không chịu trách nhiệm các trường hợp khách hàng vi phạm các hình thức sử dụng không được chấp
                                    nhận được quy định trong mục 3 trong điều khoản này.
                                </li>
                                <li>
                                    Netcode không có nghĩa vụ giám sát, kiểm soát hoạt động của người sử dụng và từ chối bất kỳ trách nhiệm
                                    nào trong việc người sử dụng lạm dụng hoặc dùng sai mục đích sử dụng hệ thống của Netcode.
                                </li>
                                <li>Netcode không hỗ trợ các thao tác quản trị nội dung website của khách hàng</li>
                                <li>
                                    Netcode đảm bảo tiếp nhận các yêu cầu hỗ trợ từ khách hàng thông qua:
                                    <ul>
                                        <li>
                                            <em>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    cung cấp các giấy tờ có liên quan theo yêu cầu của Netcode (bản sao chứng minh thư nhân dân hoặc các văn
                                    bản giấy tờ khác). Trong trường hợp khách hàng chuyển giao / bổ sung quyền quản lý / quyền sở hữu tài
                                    khoản khách hàng / các gói sản phẩm – dịch vụ khách hàng đang sử dụng, khách hàng cần đảm bảo cập nhật
                                    thông tin liên hệ đầy đủ và chính xác trong hệ thống quản lý của Netcode.
                                </li>
                                <li>
                                    Khách hàng cần phải giữ an toàn các thông tin nhận biết, mật khẩu hoặc những thông tin mật khác liên
                                    quan đến tài khoản. Lập tức thông báo cho Netcode khi phát hiện các hình thức truy cập trái phép bằng
                                    tài khoản của khách hàng hoặc các sơ hở về bảo mật, bao gồm việc mất mát, đánh cắp hoặc để lộ các thông
                                    tin về mật khẩu và các thông tin bảo mật khác.
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    dịch vụ phải cam kết phản ánh trung thực về chất lượng sản phẩm – dịch vụ của Netcode trên mọi phương
                                    tiện truyền thông, website, diễn đàn… Đồng thời mọi phản ánh đều phải kèm theo bằng chứng xác thực.
                                    Netcode có quyền đơn phương chấm dứt hợp đồng nếu phát hiện nội dung phản ánh không xác thực và mang
                                    tính công kích, bôi nhọ làm ảnh hưởng tiêu cực đến uy tín của nhà cung cấp.
                                </li>
                            </ul>
                            ...
                            <ul>
                                <li>
                                    ...
                                    trojan trên hệ thống máy chủ của Netcode.
                                </li>
                                <li>
                                    Sử dụng dịch vụ do Netcode cung cấp để tấn công, truy cập trái phép, kiểm soát chặn dữ liệu các website
                                    hoặc máy chủ của người sử dụng nhà cung cấp khác.
                                </li>
                                <li>
                                    Can thiệp thay đổi hệ thống kiểm soát, theo dõi tài nguyên và các file log gây ảnh hưởng tới quy trình
                                    quản lý điều hành của Netcode.
                                </li>
                                <li>
                            ...
                            <p>
                                ...
                                Netcode.Chúng tôi sẽ tiến hành liên hệ với khách hàng vào các thời điểm:
                            </p>
                            <ul>
                            ...
                            <p>
                                Netcode sẽ hoàn trả chi phí trong trường hợp chúng tôi không tiếp tục cung cấp những dịch vụ mà khách hàng
                                đã thanh toán. Trong trường hợp lỗi không thuộc về Netcode, mọi cước phí sẽ không được hoàn trả.
                            </p>

                            <h2>5. Ngừng cung cấp dịch vụ và xóa vĩnh viễn dịch vụ</h2>
                            <h3>5.1. Ngừng cung cấp dịch vụ</h3>
                            <p>Netcode sẽ ngừng cung cấp dịch vụ trong các trường hợp sau:</p>
                            <ul>
                                ...
                                <li>Các trường hợp phát sinh do Netcode quy định.</li>
                            </ul>

                            <h3>5.2. Xóa vĩnh viễn dịch vụ</h3>
                            <p>Netcode sẽ xóa vĩnh viễn dịch vụ trong các trường hợp sau:</p>
                            <ul>
                            ...
                            <ul>
                                <li>
                                    ...
                                    liên hệ với nhóm hỗ trợ khách hàng của Netcode để được hướng dẫn thực hiện sao lưu dữ liệu trực tiếp
                                    trên server hoặc sử dụng thêm gói dịch vụ sao lưu dữ liệu nếu cần thiết.
                                </li>
                                <li>
                                    Netcode không chịu trách nhiệm về những sự cố xảy ra cho các bản sao lưu dữ liệu do các nguyên nhân
                                ...
                                <li>
                                    Netcode chỉ có trách nhiệm phục hồi dữ liệu toàn phần (toàn bộ thư mục chứa mã nguồn, thư mục chứa email
                                    hoặc toàn bộ cơ sở dữ liệu) hoặc cung cấp bản sao lưu để khách hàng tự xử lý chứ không thực hiện việc
                                    phục hồi dữ liệu từng file riêng lẻ theo yêu cầu của khách hàng.
                                </li>
                            </ul>

                            <h2>7. Bồi thường</h2>
                            <p>
                                Trong trường hợp Netcode bị kiện bởi các hành vi của khách hàng, khách hàng phải trả tất cả các khoản phí
                                bao gồm phí tổn thất, phí tòa án.
                            </p>
